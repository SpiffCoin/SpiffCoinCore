...
// spiffcoin includes.
#include <..\src\script\spiffcoinconsensus.h>
...
int main()
{
    std::cout << "spiffcoinconsensus version: " << spiffcoinconsensus_version() << std::endl;
    ...
    auto op0Result = spiffcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, spiffcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
