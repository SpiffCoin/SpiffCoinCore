...
const std::string CURRENCY_UNIT = "SPC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    SPC_KVB,      //!< Use SPC/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from SPC/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::SPC_KVB) const;
