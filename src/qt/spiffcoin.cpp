...
#include <qt/spiffcoin.h>
#include <qt/spiffcoingui.h>
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. spiffcoin_de.qm (shortcut "de" needs to be defined in spiffcoin.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. spiffcoin_de_DE.qm (shortcut "de_DE" needs to be defined in spiffcoin.qrc)
...
static const char* qt_argv = "spiffcoin-qt";
...
void BitcoinApplication::initializeResult(bool success, interfaces::BlockAndHeaderTipInfo tip_info)
{
    ...
    if(success)
    {
        ...
        // spiffcoin: URIs or payment requests:
        if (paymentServer) {
...
int GuiMain(int argc, char* argv[])
{
    ...
    Q_INIT_RESOURCE(spiffcoin);
    Q_INIT_RESOURCE(spiffcoin_locale);
    ...
    /// 6. Determine availability of data directory and parse spiffcoin.conf
    ...
    // spiffcoin: links repeatedly have their payment requests routed to this process:
    if (WalletModel::isWalletEnabled()) {
