    ...
    mapper(nullptr)
{
    ...
    ui->spiffcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->spiffcoinAtStartup);
    ...
    ui->spiffcoinAtStartup->setToolTip(ui->spiffcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->spiffcoinAtStartup->setText(ui->spiffcoinAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->spiffcoinAtStartup, OptionsModel::StartAtStartup);
