// Copyright (c) 2011-2020 The Spiff Coin Core developers
...
public:
    ...
    QSize minimumSizeHint() const override
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnits::SPC, BitcoinUnits::maxMoney(), false, BitcoinUnits::SeparatorStyle::ALWAYS));
...
private:
    int currentUnit{BitcoinUnits::SPC};
...
#include <qt/spiffcoinamountfield.moc>
