...
/* A AEAD class for ChaCha20-Poly1305@spiffcoin.
 *
 ...
 *
 * The chacha20-poly1305@spiffcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@spiffcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@spiffcoin are relatively fast in
