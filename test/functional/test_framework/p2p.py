...
"""Test objects for interacting with a spiffcoind node over the p2p protocol.

The P2PInterface objects interact with the spiffcoind nodes under test using the
