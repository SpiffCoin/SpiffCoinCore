...
"""Verify that starting spiffcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start spiffcoin with -h for help text")
        ...
        self.log.info("Start spiffcoin with -version for version information")
        ...
        self.log.info("Start spiffcoind with -fakearg to make sure it does not start")
