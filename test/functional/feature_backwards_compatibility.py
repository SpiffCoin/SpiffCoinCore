...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes spiffcoind to exit, in addition to the RPC
        ...
        if self.is_bdb_compiled():
            ...
            # Make sure this wallet opens without warnings. See https://github.com/spiffcoin/spiffcoin/pull/19054
