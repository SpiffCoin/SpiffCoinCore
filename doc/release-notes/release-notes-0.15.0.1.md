Spiff Coin Core version *0.15.0.1* is now available from:

  <https://spiffcoin.org/bin/spiffcoin-core-0.15.0.1/>

and

  <https://spiffcoin.net/bin/spiffcoin-core-0.15.0.1/>
...
installer (on Windows) or just copy over `/Applications/Spiff Coin-Qt` (on Mac)
