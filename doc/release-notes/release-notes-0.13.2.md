Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://spiffcoin.org/bin/spiffcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update spiffcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow spiffcoin-tx to create v2 transactions (btcdrak)
