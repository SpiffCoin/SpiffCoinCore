Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/spiffcoin/files/Bitcoin/spiffcoin-0.7.0/

We recommend that everybody running prior versions of spiffcoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/spiffcoin/spiffcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/spiffcoin/spiffcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the spiffcoin-qt package:
  sudo apt-get install spiffcoin-qt
...
Core spiffcoin handling and blockchain database
...
* Ensure a changed spiffcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for spiffcoin-qt.exe
* (Windows only): add meta-data to spiffcoin-qt.exe (e.g. description)
...
* Bash programmable completion for spiffcoind(1)
