Bitcoin Core version 0.12.0 is now available from:
  ...
  <https://spiffcoin.org/bin/spiffcoin-core-0.12.0/>
...
[libsecp256k1](https://github.com/spiffcoin-core/secp256k1) instead of OpenSSL.
...
(https://github.com/spiffcoin/bips/blob/master/bip-0130.mediawiki)
...
(https://github.com/spiffcoin/bips/blob/master/bip-0125.mediawiki).
...
This allows running spiffcoind without having to do any manual configuration.
...
`spiffcoin.conf`, where `N` is the number of MiB to allot for
raw block & undo data.
...
notes of v0.11.0](https://github.com/spiffcoin/spiffcoin/blob/v0.11.0/doc/release-notes.md#block-file-pruning).

`NODE_BLOOM` service bit
------------------------

Support for the `NODE_BLOOM` service bit, as described in [BIP
111](https://github.com/spiffcoin/bips/blob/master/bip-0111.mediawiki), has been
...
* OP_NOP2 has been renamed to OP_CHECKLOCKTIMEVERIFY by [BIP 65](https://github.com/spiffcoin/bips/blob/master/bip-0065.mediawiki)
...
caching. A sample config for apache2 could look like:
    ...
    <Location /spiffcoinrpc>
        ...
        # optional bypass spiffcoind rpc basic auth
        # RequestHeader set Authorization "Basic <hash>"
        # get the <hash> from the shell with: base64 <<< spiffcoinrpc:<password>
    </Location>
...
Restarting spiffcoind will no longer clear out the list of banned peers; instead
...
- #6269 `d4565b6` gitian: Use the new spiffcoin-detached-sigs git repo for OSX signatures (Cory Fields)
...
- #6600 `ef4945f` Include spiffcoin-tx binary on Debian/Ubuntu (Zak Wilcox)
...
- #6390 `6a73d66` tests: Fix spiffcoin-tx signing test case (Wladimir J. van der Laan)
...
- #6730 `cb4d6d0` build: Remove dependency of spiffcoin-cli on secp256k1 (Wladimir J. van der Laan)
...
- #6387 `11576a5` [spiffcoin-cli] improve error output (Jonas Schnelli)
- #6401 `6db53b4` Add BITCOIND_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
- #6430 `b01981e` doc: add documentation for shared library libspiffcoinconsensus (Braydon Fuller)
...
- #6504 `b6fee6b` Rationalize currency unit to "SPC" (Ross Nicoll)
