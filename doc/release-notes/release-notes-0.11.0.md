Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://spiffcoin.org/bin/spiffcoin-core-0.11.0/>
...
defaults to 0.00001. This will cause transactions with fewer SPC/kB fee to be
...
For example, add the following to `spiffcoin.conf`:
...
related to the blockchain in the spiffcoin system: the raw blocks as received over
...
For an example script see [spiffcoin-submittx](https://github.com/laanwj/spiffcoin-submittx).
...
- #5334 `cf87536` libspiffcoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new spiffcoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add spiffcoin logo to about screen
...
- #5809 `46bfbe7` Add spiffcoin-cli man page
...
- #5849 `41259ca` contrib/init/spiffcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for spiffcoin-tx)
