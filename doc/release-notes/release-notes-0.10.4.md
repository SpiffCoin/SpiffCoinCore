Bitcoin Core version 0.10.4 is now available from:
  ...
  <https://spiffcoin.org/bin/spiffcoin-core-0.10.4/>
...
- #6953 `43c2789` Split spiffcoin-tx into its own package
- #6953 `dfe0d4d` Include spiffcoin-tx binary on Debian/Ubuntu
