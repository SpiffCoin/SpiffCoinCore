spiffcoind version 0.4.6 is now available for download at:
Windows: installer | zip (sig)
Source: tar.gz
spiffcoind and Bitcoin-Qt version 0.6.0.7 are also tagged in git, but it is recommended to upgrade to 0.6.1.
...
Correct sign message spiffcoin address tooltip. Fixes #1050 (Bitcoin-Qt)
