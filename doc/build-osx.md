...
## Running
Bitcoin Core is now available at `./src/spiffcoind`

Before running, you may create an empty configuration file:
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Bitcoin"

touch "/Users/${USER}/Library/Application Support/Bitcoin/spiffcoin.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Bitcoin/spiffcoin.conf"
```

The first time you run spiffcoind, it will start downloading the blockchain. This process could
