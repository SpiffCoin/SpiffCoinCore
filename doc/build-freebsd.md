...
This guide describes how to build spiffcoind, command-line utilities, and GUI on FreeBSD.
...
#### Wallet Dependencies
It is not necessary to build wallet functionality to run spiffcoind or the GUI. To enable legacy wallets, you must install `db5`. To enable [descriptor wallets](https://github.com/spiffcoin/spiffcoin/blob/master/doc/descriptors.md), `sqlite3` is required. Skip `db5` if you intend to *exclusively* use descriptor wallets
