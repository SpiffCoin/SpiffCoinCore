...
spiffcoin.net and spiffcoin.org and compares them.
...
WORKINGDIR = "/tmp/spiffcoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://spiffcoin.net"
HOST2 = "https://spiffcoin.org"
VERSIONPREFIX = "spiffcoin-core-"
...
def main(args):
    ...
    if not success:
        print("spiffcoin.org failed to provide signature file, "
              "but spiffcoin.net did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("spiffcoin.org and spiffcoin.net signature files were not equal?")
