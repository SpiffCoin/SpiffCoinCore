...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the spiffcoin repository."
  exit 1
fi
...
# See https://github.com/spiffcoin/spiffcoin/issues/16064
...
echo 'When compiling spiffcoind, run `./configure` in the following way:'
echo
