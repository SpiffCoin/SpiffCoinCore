...
INFO: Building commit ${GIT_COMMIT:?not set} for platform triple ${HOST:?not set}:
      ...
      ...from worktree directory: '${PWD}'
          ...bind-mounted in container to: '/spiffcoin'
...
EOF
        ...
        #     same exact path (e.g. mapping '/home/satoshi/spiffcoin/' to
        #     '/home/satoshi/spiffcoin/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/spiffcoin
        #
        #                     maps our current working directory to /spiffcoin
        ...
        #     container so that we have something to build. '/spiffcoin' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                        ...
                                        OUTDIR=/outdir \
                                      bash -c "cd /spiffcoin && bash contrib/guix/libexec/build.sh"
    )
