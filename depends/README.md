...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_spiffcoin` executable (see https://github.com/spiffcoin/spiffcoin/pull/13543),
...
options will be passed to spiffcoin's configure. In this case, `--disable-wallet`.
